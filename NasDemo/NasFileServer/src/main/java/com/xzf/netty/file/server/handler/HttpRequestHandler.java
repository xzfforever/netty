...
import com.xzf.netty.file.server.HttpFileServer;
...
public class HttpRequestHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    public HttpRequestHandler(String localDir){
        DiskFileUpload.baseDirectory  = localDir;
    }
    ...
    private void writeResponse(ChannelHandlerContext ctx, HttpResponseStatus status, String msg) throws Exception{
        ByteBuf byteBuf = Unpooled.copiedBuffer((msg+CRLF).getBytes("UTF-8"));
    ...
    private String buildUrl(String dir,String fileName){
        StringBuilder sb = new StringBuilder("http://").append(HttpFileServer.SERVER_NAME)
                .append(":").append(HttpFileServer.PORT).append("/get");
        // TODO 增加Base64编码
    ...
    private void initPostRequestDecoder(FullHttpRequest request){
        ...
        decoder = new HttpPostRequestDecoder(factory, request, Charsets.UTF_8);
    }
